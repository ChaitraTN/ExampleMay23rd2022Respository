...
public class Assignment6ModifyProject {
	...
	private static void createCustomer()
	{
		try
		{
			...
			Thread.sleep(3000);
			oBrowser.findElement(By.id("customerLightBox_nameField")).sendKeys("Bharath");
			oBrowser.findElement(By.id("customerLightBox_descriptionField")).sendKeys("Name:Bharath, Phno. 908776655, Vijaynagar");
			Thread.sleep(3000);
	...
	private static void modifyProject()
	{
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[4]/div[2]/div[1]/div[1]/div[2]/div[2]/div/div[1]/textarea")).sendKeys("Project based on ATM banking, cash deposit,Cash withdraw");
			Thread.sleep(2000);
		}catch(Exception e)
		{
			e.printStackTrace();
