...
public class Assignment2ModifyUser {
	...
	private static void createUser()
	{
		try
		{
			...
			Thread.sleep(1000);
			oBrowser.findElement(By.name("firstName")).sendKeys("Chaitra");
			oBrowser.findElement(By.name("lastName")).sendKeys("Tumkur");
			oBrowser.findElement(By.name("email")).sendKeys("chaitra@gmail.com");
			oBrowser.findElement(By.name("username")).sendKeys("ChaitraTN");
	...
	private static void modifyUser()
	{
		try
		{
			...
			oBrowser.findElement(By.id("userDataLightBox_lastNameField")).sendKeys("MohanKumar");
			Thread.sleep(3000);
